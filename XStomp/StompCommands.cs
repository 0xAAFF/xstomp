...
namespace XStomp
{
    ...
    public static class StompCommands
    {
        ...
        private static readonly ICollection<string> _clientCommandSet = new HashSet<string> { Send, Subscribe, Unsubscribe, Begin, Commit, Abort, Ack, Nack, Disconnect, Connect, Stomp };
        ...
        private static readonly ICollection<string> _serverCommandSet = new HashSet<string> { Connected, Message, Receipt, Error };
